...
export const customThemes: Array<ThemeOption> = [
  {
    id: "obsidian",
    label: "Obsidian",
  ...
  },
  {
    ...
    preview: {
      from: "oklch(0.97 0.02 85)",
      to: "oklch(0.92 0.06 75)",
  ...
  },
  {
    ...
    preview: {
      from: "oklch(0.64 0.24 265)",
      to: "oklch(0.7 0.2 280)",
  ...
  },
  {
    ...
    preview: {
      from: "oklch(0.18 0.04 55)",
      to: "oklch(0.24 0.06 50)",
  ...
  },
  {
    ...
    preview: {
      from: "oklch(0.32 0.05 220)",
      to: "oklch(0.62 0.2 205)",
      accent: "oklch(0.7 0.2 175)",
    },
    group: "custom",
  },
  {
    ...
    preview: {
      from: "oklch(0.14 0.03 255)",
      to: "oklch(0.2 0.04 250)",
  ...
  },
  {
    ...
    preview: {
      from: "oklch(0.95 0.01 250)",
      to: "oklch(0.88 0.02 245)",
      accent: "oklch(0.74 0.18 65)",
    },
    group: "custom",
  },
];

export const systemThemes: Array<ThemeOption> = [
  {
    id: "light",
    label: "Light",
    description: "Default light theme.",
    preview: {
      from: "oklch(0.98 0.01 210)",
      to: "oklch(0.88 0.05 215)",
      accent: "oklch(0.68 0.24 205)",
    },
    group: "system",
  },
  {
    ...
    preview: {
      from: "oklch(0.18 0.008 240)",
      to: "oklch(0.22 0.008 240)",
  ...
  },
  {
    ...
    preview: {
      from: "oklch(0.9 0.02 210)",
      to: "oklch(0.7 0.1 210)",
      accent: "oklch(0.6 0.18 205)",
    },
    group: "system",
  },
];
...
export const themeOptions = [...customThemes, ...systemThemes];
